        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              最先端のAI技術を活用し、企業のデジタル変革を支援するAIオーケストレーション開発・コンサルティング企業です。
            </p>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-indigo-400">会社情報</h4>
            <div className="space-y-3 text-gray-300">
              <div>
                <p className="font-semibold text-white">株式会社ALPHABET</p>
              </div>
              <div>
                <p className="text-sm text-gray-400">本社所在地</p>
                <p>〒104-0061</p>
                <p>東京都中央区銀座1丁目12番4号</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} 株式会社ALPHABET. All rights reserved.
            </p>
